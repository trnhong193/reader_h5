...
def merge_reports(output_file='report_python.md'):
    ...
    print("=" * 80)
    print("GỘP CÁC FILE BÁO CÁO PYTHON")
    print("=" * 80)
    ...
    # Thêm tiêu đề chung
    merged_content.append("# BÁO CÁO TỔNG HỢP: CẤU TRÚC CÁC FILE H5 (PYTHON)\n")
        ...
        if os.path.exists(report_path):
            ...
            with open(report_path, 'r', encoding='utf-8') as f:
                ...
                if first_line.startswith('#'):
                    ...
                    # Loại bỏ "(MATLAB)" hoặc "(PYTHON)" nếu có
                    title = title.replace(' (MATLAB)', '').replace(' (PYTHON)', '')
...
def main():
    ...
    print("=" * 80)
    print("GỘP VÀ CHUYỂN ĐỔI BÁO CÁO PYTHON")
    print("=" * 80)
    
    # 1. Gộp các file báo cáo
    merged_file = merge_reports('report_python.md')
